...
typedef struct
{
    ...
    Adc_ChannelType         Adc_ChannelConversionId; /*!< Current channel */
    ...
    Adc_StreamNumSampleType Adc_SamplesResultCounter; /*!< Current sample count */
...
typedef struct
{
    ...
    // Adc_GroupType*          AdcHw_GroupQueue;       /*!< Group queue array */
    // Adc_GroupType           AdcHw_GroupQueueSize;   /*!< Queue size */
    // Adc_GroupType           AdcHw_CurrGroupRegisterId; /*!< Current group ID */
    // Adc_GroupType           AdcHw_NbrOfGroupRegister; /*!< Number of queued groups */
    
    /* Hardware Features */
    Adc_HwNvicType          AdcHW_Nvic;             /*!< Interrupt type */
    uint8                   AdcHw_DMAAvailable;     /*!< DMA availability */
    uint8                   AdcHw_HWTrigger;        /*!< HW trigger support */
 ...
 */
#define ADC_GET_HW_MODULE_ID(id) \
    ((id == 1) ? ADC1 : (id == 2) ? ADC2 : ((ADC_TypeDef*)0))
 ...
 */
#define ADC_GET_HW_DMA_ID(id) \
    ((id == 1) ? DMA1_Channel1 : ((DMA_Channel_TypeDef*)0))
...
typedef struct
{
    ...
    uint8                   HwUnitBusy;             /*!< Hardware unit busy flag */
