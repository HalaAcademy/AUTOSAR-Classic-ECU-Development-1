...
****************************************************************************************/
#define ADC_HW_IS_VALID_UNIT(id)    (((id) >= 1) && ((id) <= ADC_MAX_HW_UNITS))
...
****************************************************************************************/
/**
 * @brief Get ADC hardware module pointer
 */
#define ADC_HW_GET_MODULE(id)       ((id == 1) ? ADC1 : \
                                     (id == 2) ? ADC2 : \
                                     (ADC_TypeDef*)0)

/**
 * @brief Get DMA channel pointer for ADC unit
 */
#define ADC_HW_GET_DMA_CHANNEL(id)  ((id == 1) ? DMA1_Channel1 : \
                                     (DMA_Channel_TypeDef*)0)
