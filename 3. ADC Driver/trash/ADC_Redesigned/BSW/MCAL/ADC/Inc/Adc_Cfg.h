...
#define ADC_DEV_ERROR_DETECT        STD_ON  /*!< Enable development error detection */
...
#define ADC_SAMPLING_TIME_DEFAULT   ADC_SampleTime_55Cycles5  /*!< Default sampling time */
...
void Adc_Group4_Notification(void);
